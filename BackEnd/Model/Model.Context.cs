...
public partial class SCJ_BDEntities : DbContext
{
    ...
    public virtual ObjectResult<sp_listaEntradas_Result> sp_listaEntradas()
    {

        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_listaEntradas_Result>("sp_listaEntradas");
    }


    public virtual ObjectResult<sp_listaSalidas_Result> sp_listaSalidas()
    {

        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_listaSalidas_Result>("sp_listaSalidas");
    }
